Open Loops - installer for macOS
=================================

1. Double-click "Install Open Loops".
   macOS will probably say it cannot check the app for malicious software, because it is
   not signed with an Apple Developer ID. To run it anyway:
     - macOS 14 and earlier: right-click (or Control-click) the app and choose Open, then Open again.
...
2. A Terminal window opens. It downloads Open Loops from https://github.com/@REPO@,
   installs Python if you do not have it, and asks for your first name.
3. When it finishes, Open Loops.app (the orange loop) is on your Desktop and in the Dock,
   and the app opens to walk you through installing the AI (one button, Install Claude) and
