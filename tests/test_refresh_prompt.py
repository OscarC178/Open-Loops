...
check("LATEST message is from someone" in ib and "Oscar's own messages" in ib and "bots" in ib, "Slack inbound keeps only unanswered asks from people, never the owner's own")
